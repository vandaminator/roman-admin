...
{#if product.length !== 0}
  ...
  >
    ...
    <label class="label">
      ...
      <p>
        ...
        > and press your products image to get the link for the image by pressing
        the "Get Url" button and paste here. To upload many just separate them with
        a comma(,)
      </p>
    </label>
  ...
  {#if firstFormGood}
    <div class="flex items-center flex-col gap-9">
      <h1 class="text-4xl">Product was updated</h1>
      <a
